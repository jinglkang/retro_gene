...
use Getopt::Long;
open IN,"$ARGV[0]" || die"!";
#name	3433	1534	4633	2197

while (<IN>) {
chomp;
my @infor=split /\t/,$_;

my @data=($infor[1],$infor[2],$infor[3],$infor[4]);
my $p_value=&fisher(@data);
print "$infor[0]\t",$infor[1]/$infor[2],"\t",$infor[3]/$infor[4],"\t",$infor[1]/$infor[2]-$infor[3]/$infor[4],"\t$p_value\n";
}
